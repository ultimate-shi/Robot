...
# 可覆盖示例：STEREO_EXPOSURE=200 STEREO_WHITE_BALANCE=5000 bash scripts/stereo/configure_stereo_camera.sh
# 一次性自动调节：STEREO_AUTO_TUNE=1 bash scripts/stereo/configure_stereo_camera.sh
